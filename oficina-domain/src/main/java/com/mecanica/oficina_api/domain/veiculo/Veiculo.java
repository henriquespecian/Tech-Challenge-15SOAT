...
public class Veiculo {
    ...
    public static Veiculo reconstituir(String id, String clienteId, String placa, String marca, String modelo, int ano, String cor, boolean ativo) {
        Veiculo veiculo = new Veiculo();
        veiculo.id = Objects.requireNonNull(id, "ID é obrigatório");
        veiculo.clienteId = Objects.requireNonNull(clienteId, "Cliente é obrigatório");
        veiculo.marca = Objects.requireNonNull(marca, "Marca é obrigatória");
        veiculo.modelo = Objects.requireNonNull(modelo, "Modelo é obrigatório");
        veiculo.setAno(ano);
