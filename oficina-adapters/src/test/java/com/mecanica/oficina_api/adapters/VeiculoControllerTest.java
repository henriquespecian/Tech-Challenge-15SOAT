...
class VeiculoControllerTest {
    ...
    private Veiculo veiculo(String id, String placa) {
        return Veiculo.reconstituir(id, "cliente-1", placa, "Toyota", "Corolla", 2020, "Branco", true);
    }
    ...
    void deveCadastrarVeiculoERetornar201() throws Exception {
        ...
        when(veiculoService.cadastrar(anyString(), anyString(), anyString(), anyString(), anyInt(), anyString()))
                .thenReturn(veiculo("veiculo-1", "ABC1234"));
    ...
    void deveBuscarVeiculoPorIdERetornar200() throws Exception {
        when(veiculoService.buscarPorId("veiculo-1")).thenReturn(veiculo("veiculo-1", "ABC1234"));
    ...
    void deveListarVeiculosPorClienteERetornar200() throws Exception {
        when(veiculoService.listarPorCliente("cliente-1")).thenReturn(List.of(
                veiculo("veiculo-1", "ABC1234"),
                Veiculo.reconstituir("veiculo-2", "cliente-1", "XYZ5678", "Honda", "Civic", 2022, "Preto", true)
        ));
    ...
    void deveAlterarVeiculoERetornar200() throws Exception {
        ...
        when(veiculoService.alterar(eq("veiculo-1"), anyString(), anyString(), anyString(), anyInt(), anyString()))
                .thenReturn(Veiculo.reconstituir("veiculo-1", "cliente-1", "XYZ9999", "Honda", "Civic", 2023, "Preto", true));
