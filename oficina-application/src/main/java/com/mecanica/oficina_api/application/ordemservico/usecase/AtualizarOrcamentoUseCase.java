...
public class AtualizarOrcamentoUseCase {
    ...
    public AtualizarOrcamentoUseCase(OrdemServicoGateway ordemServicoGateway, MontadorItensOrcamento montadorItensOrcamento) {
    ...
    public OrdemServico executar(String id, GerarOrcamentoInput input) {
        ...
        os.atualizarOrcamento(montadorItensOrcamento.montar(input), input.observacoes());
